        ...
        Column(
            ...
            Column (
                ...
                avatarUri?.let {
                    ...
                    Image(painter = image, contentDescription = "Avatar", modifier = Modifier.size(100.dp))
                }
                ...
                CustomButton(
                    text = "Đăng kí",
                    onClick = {
                        registerViewModel.register(context, RegisterRequest(email, password, avatarUri))
                    },
                    modifier = Modifier.padding(vertical = 5.dp),
                    isLoading
                )
                ...
                OutlinedButton(
                    ...
                    Row(
                        ...
                        Text("Đăng kí với Google", fontSize = 20.sp)
                    }
                }
            }
            ...
            Column(
                ...
                Row(
                    ...
                    Text("Bạn đã có tài khoản ? ", color = Color.Black, fontSize = 18.sp)
                    TextButton(
                        onClick = {navController.navigate(Screen.LoginScreen.route) },

                        ) {
                        Text("Đăng nhập", color = MainColor, fontSize = 18.sp)
                    }
                }
